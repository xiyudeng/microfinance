...
data_duration = array2table(normrnd(data_structure.duration_nor.mu, data_structure.duration_nor.sigma, pool_size,1),"VariableNames",["duration"]);

data_entries = array2table(normrnd(data_structure.entries_nor.mu, data_structure.entries_nor.sigma, pool_size,1),"VariableNames",["journal_totals_entries"]);

data_amount = array2table(normrnd(data_structure.amount_nor.mu, data_structure.amount_nor.sigma, pool_size,1),"VariableNames",["terms_loan_amount"]);
